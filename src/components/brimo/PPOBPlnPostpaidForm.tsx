...
interface PPOBPlnPostpaidFormProps {
  onReview: (data: PPOBPlnPostpaidFormValues) => void;
  onDone: () => void;
}
...
export default function PPOBPlnPostpaidForm({ onReview, onDone }: PPOBPlnPostpaidFormProps) {
  ...
  const onSubmit = (values: PPOBPlnPostpaidFormValues) => { onReview(values); };
