...
interface PPOBPlnPostpaidReviewProps {
    formData: PPOBPlnPostpaidFormValues;
    onConfirm: () => void;
    onBack: () => void;
}
...
export default function PPOBPlnPostpaidReview({ formData, onConfirm, onBack }: PPOBPlnPostpaidReviewProps) {
            ...
            <ScrollArea className="flex-1 -mx-6 px-6">
                <div className="space-y-6 pt-4 pb-6">
                    <div className="space-y-2">
                        <h4 className="font-semibold text-lg">Detail Tagihan PLN Pascabayar</h4>
