...
interface PPOBWifiFormProps {
  onReview: (data: PPOBWifiFormValues) => void;
  onDone: () => void;
}
...
export default function PPOBWifiForm({ onReview, onDone }: PPOBWifiFormProps) {
  ...
  const onSubmit = (values: PPOBWifiFormValues) => { onReview(values); };
