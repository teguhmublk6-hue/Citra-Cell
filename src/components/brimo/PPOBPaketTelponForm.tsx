...
interface PPOBPaketTelponFormProps {
  onReview: (data: PPOBPaketTelponFormValues) => void;
  onDone: () => void;
}
...
export default function PPOBPaketTelponForm({ onReview, onDone }: PPOBPaketTelponFormProps) {
  ...
  const onSubmit = (values: PPOBPaketTelponFormValues) => { onReview(values); };
